...
(async function () {
  ...
  function showSuspended() {
    ...
    const clientBody = (
      '<h1 class="ns-head">This website is temporarily offline</h1>'
      + '<p class="ns-body">We are back shortly. '
      + (igLink ? 'In the meantime you can see our latest stock and order on Instagram.' : 'Please check back soon.')
      + '</p>'
      + (igLink ? '<a class="ns-wa" href="' + igLink + '" target="_blank" rel="noopener">' + IG_SVG + ' See us on Instagram</a>' : '')
    );
